...
public class PerEmpController {
    ...
    @GetMapping("/")
    public RespBean getEmployeeByPage(@RequestParam(defaultValue = "1") Integer currentPage,
    ...
    public void exportEmployee(HttpServletResponse response,@RequestParam(required = false) String name){
        employeeService.exportEmployee(response,name);
    }
