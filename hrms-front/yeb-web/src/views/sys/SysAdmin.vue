      ...
      <el-card class="admin-card" v-for="(admin, index) in admins" :key="index">
        ...
        <div>
          <div class="img-container">
            <img :src="getImage(admin.userFace)" :alt="admin.name" :title="admin.name" class="userface-img">
          </div>
        </div>
        <div class="userinfo-container">
          ...
          <div>用户角色:
            ...
            <el-popover placement="right" title="角色列表" @show="showPop(admin)" @hide="hidePop(admin)" width="200"
              trigger="click">
              <el-select v-model="selectedRoles" multiple placeholder="请选择...">
                <el-option v-for="(r, indexk) in allRoles" :key="indexk" :label="r.nameZh" :value="r.id"></el-option>
              </el-select>
